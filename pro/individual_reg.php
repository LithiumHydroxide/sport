...
<div class="signup-page">
    <div class="form">
        ...
        <p class="alert alert-info">
            <marquee behavior="" scrollamount="2" direction="">You need to create an account to book/view games!
            </marquee>
        </p>
        <form class="login-form" method="post" role="form" enctype="multipart/form-data" id="signup-form"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="phone" name="phone" minlength="11" maxlength="11" pattern="[0-9]{11}" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">

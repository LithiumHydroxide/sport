                ...
                <div class="col-sm-12">
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">
                                All Oncoming Matches and games</h3>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $fetch['stop'];
                                                ...
                                                $fullname = $fetch['start'] . " vs " . $fetch['stop']; ?></td>
                                        <td>
                                            <form method="POST">
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post">
                                                        <input type="hidden" class="form-control" name="id"
                                                            value="<?php echo $id ?>" required id="">
                                                        <p>Team : <input type="text" class="form-control"
                                                                value="<?php echo $fetch['start'] ?>" name="start"
                                                                required id="">
                                                        </p>
                                                        <p> Versus : <input type="text" class="form-control"
                                                                value="<?php echo $fetch['stop'] ?>" name="stop"
                                                                required id="">
                                                        </p>
                                                        <p>

                                                            <input class="btn btn-info" type="submit" value="Edit Match"
                                                                name='edit'>
                                                        </p>
                                                    </form>
...
<div class="modal fade" id="add">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" align="center">
            <div class="modal-header">
                <h4 class="modal-title">Add New Match &#128649;
                </h4>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <input class="btn btn-info" type="submit" value="Add Match" name='submit'>
                            </td>
                        </tr>
                    </table>
                </form>
...
if (isset($_POST['del_train'])) {
    ...
    if ($con->affected_rows < 1) {
        alert("The match Could Not Be Deleted. This Match Has Been Tied To Another Data!");
        load($_SERVER['PHP_SELF'] . "$me");
    } else {
        alert("Match Deleted!");
        load($_SERVER['PHP_SELF'] . "$me");

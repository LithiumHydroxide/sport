                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="" method="post">
                                                        ...
                                                        <p>Team : <select class="form-control" name="train_id" required
                                                                id="">
        ...
        <div class="modal-content" align="center">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    <div class="row">
                        <div class="col-sm-6">
                            Stadium : <select class="form-control" name="train_id" required id="">
                        ...
                        <div class="col-sm-6">
                            Match : <select class="form-control" name="route_id" required id="">

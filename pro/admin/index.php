    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box bg-info">
                <span class="info-box-icon"><i class="nav-icon far fa-futbol"></i></span>
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box bg-primary">
                <span class="info-box-icon"><i class="nav-icon fas fa-walking"></i></span>

                <div class="info-box-content">
                    <span class="info-box-text">Stadiums
                    </span>

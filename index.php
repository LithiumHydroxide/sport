                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <p class="main-heading-text">WELCOME TO,<br />E - TICKETING FOR GAMES</p>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <h1 class="main-heading-title">Companies Motto</h1>

                            <p class="main-heading-text">
                            The customer is at the heart of our unique business model, which inculde online and virtual games booking.</p>
                ...
                <div class="row about-box">
                    ...
                    <div class="col-sm-4 text-center">
                        ...
                        <div class="margin-bottom">
                            ...
                            <h4>Get Game Tickets from the comfort of your home</h4>

                            <p class="black">Book game tickets from anywhere using the robust ticketing platform
                                exclusively built to provide the clients with pleasant ticketing experience. </p>
                    ...
                    <div class="col-sm-4 about-line text-center">
                        ...
                        <div class="margin-bottom">
                            ...
                            <h4>Reservation & Ticketing related information at your fingertips</h4>

                            <p class="black">Checkout available seats, game time and game information on real time
        ...
        <footer class="site-footer section-spacing text-center " id="eight">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4"> <small>&copy; <?php echo date('Y'); ?>, Developed By Rebecca Adeng </small></div>
